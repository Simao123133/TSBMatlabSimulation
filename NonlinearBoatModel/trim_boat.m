...
%% Perform the operating point search
    ...
    save('MatFiles/trim_op_fixed_v.mat','op','FF_L','FF_R','rear_alfas','T','gg','initial_uspeed','initial_wspeed','initial_Q','initial_Pitch','initial_Z','initial_vspeed','initial_P','initial_R','initial_ROLL','initial_YAW')
