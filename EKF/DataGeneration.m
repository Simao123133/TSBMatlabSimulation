...
%% Organize variables
state(1) = arrange(Motor1_duty__44_M1_RPM_01);
state(1).val = state(1).val;
state(2) = arrange(Foils_US_ang_42_right_angle_03);
state(3).val = 1.91*ones(length(state(1).time),1);
state(3).time = state(1).time;
state(4) = arrange(XCDI_Velocit_64_velX_00);
state(5) = arrange(XCDI_Velocit_64_velZ_02);
state(6) = arrange(XCDI_RateOfT_61_gyrY_01);
state(6).val = state(6).val*180/pi;
state(7) = arrange(XCDI_EulerAn_58_pitch_00);
state(8) = arrange(Foils_US_ang_42_dist_01);
state(9) = arrange(XCDI_Velocit_64_velY_01);
state(10) = arrange(XCDI_RateOfT_61_gyrX_00);
state(10).val = state(10).val*180/pi;
state(11) = arrange(XCDI_RateOfT_61_gyrZ_02);
state(11).val = state(11).val*180/pi;
state(12) = arrange(XCDI_EulerAn_58_roll_01);
state(13) = arrange(XCDI_EulerAn_58_yaw_02);
state(14) = arrange(Foils_US_ang_42_left_angle_02);
speed = arrange(Foils_setpoi_41_Speed_03);
late_i = state(1).time(113259);
