syms u w qq Pitch z v p r Roll Yaw
syms Act_front_left Act_front_right Act_rear Rpms_motor Rudder
...
X_dot = V_inertial(1);
Y_dot = V_inertial(2);
Z_dot = V_inertial(3) + qq*pi/180*dist_cm_Us_x;

xdot = [u_dot;w_dot;q_dot;Pitch_dot;Z_dot;v_dot;p_dot;r_dot;Roll_dot;Yaw_dot];
jac = jacobian(xdot,[u;w;qq;Pitch;z;v;p;r;Roll,Yaw]);
matlabFunction(jac,'File','jac_onwater','Optimize',false);
