...
def f(x, p00,p10,p01,p20,p11,p02,p30,p21,p12,p31,p22,p32):
    aa = x[0]
    Re = x[1]
    x=aa
    y=Re
    ...
    return (p00 + p10*x + p01*y + p20*x**2 + p11*x*y + p02*y**2 + p30*x**3 + p21*x**2*y 
        + p12*x*y**2 + p31*x**3*y + p22*x**2*y**2 + p32*x**3*y**2)
...
def f_aa(aa, speed, p00,p10,p01,p20,p11,p02,p30,p21,p12,p31,p22,p32):
    rho= 1025.00 
    mu= 1.14E-3 
    c_FF=0.08 
